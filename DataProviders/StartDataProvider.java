...
public class StartDataProvider {
	...
	public static Object [][] getCoordinatesOfMainElements(){
		 return new Object [][] {
			 {"Логотип", "/html/body/div/header/div/div", 588, 5, 741, 5},
			 {"Метеоблок","/html/body/div/header/div/div/div[2]", 830, 13, 1059, 13},
			 {"Статистика посещений","/html/body/div/header/div/div/div[1]", 737, 13, 966, 13},
			 {"Первый верхний рекламный блок","/html/body/div/section[1]/div/div[1]", 1, 190, 39, 192},
			 {"Второй верхний рекламный блок","/html/body/div/section[1]/div/div[2]", 327, 190,  429, 192},
			 {"Третий верхний рекламный блок","/html/body/div/section[1]/div/div[3]", 653, 190, 819, 192},
			 {"Загловок Топ-новости","/html/body/div/section[2]/div/aside[1]/div[1]/h3", 690, 325, 919, 332},
			 {"Катритнка Топ-новостей","/html/body/div/section[2]/div/aside[1]/div[1]/div/div[1]",690, 367, 919, 374},
			 ...
			 {"Заголовок Реклама","/html/body/div/section[2]/div/aside[1]/div[2]/h3", 690, 439, 919, 405},
			 {"Реклама слева","/html/body/div/section[2]/div/aside[1]/div[2]/div",690, 439, 919, 447},
			 {"Заголовок Статьи","/html/body/div/section[2]/div/aside[1]/div[3]/h3", 690, 704, 919, 1062},
			 {"Собственно Статьи","/html/body/div/section[2]/div/aside[1]/div[3]/div", 690, 745, 919, 1103},
			 {"Заголовок видео","/html/body/div/section[2]/div/aside[1]/div[4]/h3", 690, 760, 919, 1118},
